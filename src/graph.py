...
class Graph:
    ...
    def getNodes(self):  # Gel all nodes of the graph
        return self.m_nodes
    ...
    def calcula_custo(self, caminho):  # Given a certain path, this function calculates his overall cost
    ...
    def getNeighbours(self, nodo):  # Returns the neighbours of the given node
        lista = []
        for (adjacente, peso) in self.m_graph[nodo]:
            lista.append((adjacente, peso))
        return lista

    def desenha(self):  # Plot the graph
    ...
    def add_heuristica(self, n, estima):  # Defines the heuristic for each node
        n1 = Node(n)
    ...
    def getH(self, nodo):  # Returns the node's heuristic
